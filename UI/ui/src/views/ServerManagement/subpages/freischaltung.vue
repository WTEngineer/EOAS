      ...
      <div class="tw-w-full tw-mt-4 tw-mb-8" style="padding: 10px 10px">
        <div class="tw-w-full" style="display: flex; justify-content: center; align-items: center;">
          <div class="tw-w-4-1" style="text-align: right">
            <label class="form-input-label">{{ $t('GSG-1-IP') }}</label>
          </div>
        ...
        <div class="tw-w-full" style="display: flex; justify-content: center; align-items: center;">
          <div class="tw-w-4-1" style="text-align: right">
            <label class="form-input-label">{{ $t('GSG-2-IP') }}</label>
          </div>
          <div class="tw-w-4-3" style="text-align: left; padding-left: 30px">
        ...
        <div class="tw-w-full" style="display: flex; justify-content: center; align-items: center;">
          <div class="tw-w-4-1" style="text-align: right">
            <label class="form-input-label">{{ $t('GSG-3-IP') }}</label>
          </div>
          <div class="tw-w-4-3"
        ...
        <div class="tw-w-full" style="display: flex; justify-content: center; align-items: center;">
          <div class="tw-w-4-1" style="text-align: right">
            <label class="form-input-label">{{ $t('GSG-4-IP') }}</label>
          </div>
          <div class="tw-w-4-3" style="text-align: left; padding-left: 30px">
            <v-text-field v-model="form.username" :label="$t('')" prepend-inner-icon="mdi-account"
              style="max-width: 600px; height: 60px" background-color="var(--cui-bg-card)"
        ...
        <div class="tw-w-full" style="display: flex; justify-content: center; align-items: center;">
          <div class="tw-w-4-1" style="text-align: right">
            <label class="form-input-label">{{ $t('GSG-5-IP') }}</label>
          </div>
          <div class="tw-w-4-3" style="text-align: left; padding-left: 30px">
            <v-text-field v-model="form.username" :label="$t('')" prepend-inner-icon="mdi-account"
              style="max-width: 600px; height: 60px" background-color="var(--cui-bg-card)"
        ...
        <div class="tw-w-full" style="display: flex; justify-content: center; align-items: center;">
          <div class="tw-w-4-1" style="text-align: right">
            <label class="form-input-label">{{ $t('GSG-6-IP') }}</label>
          </div>
          <div class="tw-w-4-3" style="text-align: left; padding-left: 30px">
            <v-text-field v-model="form.username" :label="$t('')" prepend-inner-icon="mdi-account"
              style="max-width: 600px; height: 60px" background-color="var(--cui-bg-card)"
        ...
        <div class="tw-w-full" style="display: flex; justify-content: center; align-items: center;">
          <div class="tw-w-4-1" style="text-align: right">
            <label class="form-input-label">{{ $t('GSG-7-IP') }}</label>
          </div>
          <div class="tw-w-4-3" style="text-align: left; padding-left: 30px">
            <v-text-field v-model="form.username" :label="$t('')" prepend-inner-icon="mdi-account"
              style="max-width: 600px; height: 60px" background-color="var(--cui-bg-card)"
        ...
        <div class="tw-w-full" style="display: flex; justify-content: center; align-items: center;">
          <div class="tw-w-4-1" style="text-align: right">
            <label class="form-input-label">{{ $t('VDHI-Pass') }}</label>
          </div>
          <div class="tw-w-4-3" style="text-align: left; padding-left: 30px">
            <v-text-field v-model="form.username" :label="$t('')" prepend-inner-icon="mdi-account"
              style="max-width: 600px; height: 60px" background-color="var(--cui-bg-card)"
