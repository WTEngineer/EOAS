...
class InferenceSess(onnxruntime.InferenceSession): 
...
class ModelRouter:
    ...
    def get_model(self, **kwargs):
        session = InferenceSess(self.onnx_file, **kwargs)
        ...
        if len(outputs)>=5:
            ...
            return Swapper(model_file=self.onnx_file, session=session)
